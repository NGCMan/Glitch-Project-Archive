function getPointGen() {
  ...
  if (inChallenge("am", 12)) gain = gain.pow(0.1);
  return gain;
}
...
function getIncBuyableFormulaText(id) {
  ...
  if (id == 13) {
    ...
    if (!hasUpgrade("a", 14) && !hasUpgrade("pi", 32))
      start = "1e5*" + linear + quad;

    let y = getBuyableAmount("i", 13)
      .minus(4)
      .max(1);
...
function getBChallengeTotal() {
  return (
    challengeCompletions("b", 11) +
    challengeCompletions("b", 12) +
    challengeCompletions("b", 21) +
    challengeCompletions("b", 22)
  );
}
...
function getStaminaMaximumAmount() {
  ...
  if (hasUpgrade("pi", 33))
    a += Math.max(0, player.pi.upgrades.length - 10) * 10;
  if (hasUpgrade("p", 41)) {
    a += 2;
...
addLayer("i", {
  ...
  getGainExp(unsoftcapped) {
    ...
    if (hasUpgrade("pi", 34))
      x = x.pow(Decimal.pow(1.1, player.pi.upgrades.length));
    if (hasUpgrade("p", 42))
      x = x.pow(Decimal.pow(1.0001, player.p.upgrades.length ** 2));
    if (hasUpgrade("sp", 51)) {
      let a = 1;
  ...
  upgrades: {
    ...
    12: {
      title: "Cash",
      description:
        "Unlock the first repeatable upgrade and each upgrade in this row multiples Incrementy gain by 1.1",
      cost: new Decimal(30),
      unlocked() {
    ...
    24: {
      title: "Flour",
      description:
        "Remove the linear cost scaling of Incrementy Stamina and Cache is based on best Incrementy",
    ...
    32: {
      ...
      unlocked() {
        return (
          (hasAMUpgrade(13) && getBuyableAmount("i", 12).gte(17)) ||
          hasUnlockedRow(2)
        );
      }
    },
    33: {
      title: "Hall",
      description:
        "Each Incrementy Strength adds .02 to the Incrementy Strength base (capped at 10)",
      cost: new Decimal(1e34),
      unlocked() {
        return (
          (hasAMUpgrade(13) && getBuyableAmount("i", 11).gte(89)) ||
          hasUnlockedRow(2)
        );
      }
    },
    34: {
      title: "Haul",
      description:
        "Each Incrementy Speed adds .01 to the Incrementy Speed base (capped at 10)",
      cost: new Decimal(1e37),
      unlocked() {
        return (
          (hasAMUpgrade(13) && getBuyableAmount("i", 13).gte(19)) ||
          hasUnlockedRow(2)
        );
      }
    },
    15: {
      title: "Currently,",
      description:
        "Each upgrade in this column adds .5 to the Neutrino Generation buyable base",
    ...
    35: {
      title: "Friendless.",
      description:
        "Amoeba Gain buyables give free levels to Incrementy Boost buyables",
  ...
  buyables: {
    ...
    11: {
      ...
      display() {
        ...
        let eff =
          "<b><h2>Effect</h2>: x" + format(getIBuyableEff(11)) + "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getIBuyableCost(11)) +
          " Incrementy</b><br>";
        let cformula =
          "<b><h2>Cost formula</h2>:<br>" +
          getIncBuyableFormulaText(11) +
          "</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.i.buyables[11].effectBase()) +
          "^x</b><br>";
      ...
      cost(a) {
        ...
        let exp2 = x
          ...
          .max(0)
          .times(x);
        return Decimal.pow(base1, x)
          .times(Decimal.pow(1.01, exp2))
          .times(10);
      },
      effectBase() {
      ...
      canAfford() {
        return (
          player.i.points.gte(getIBuyableCost(11)) &&
          player.i.buyables[11].lt(5e5)
        );
      },
      total() {
      ...
      extra() {
        ...
        ret = ret.plus(
          layers.b.challenges[12]
            .rewardEffect()
            .times(layers.i.buyables[13].total())
            .floor()
        );
        return ret;
      },
      ...
      unlocked() {
        return hasIUpg(12) || hasUnlockedRow(3);
      }
    },
    12: {
      ...
      display() {
        ...
        let eff =
          "<b><h2>Effect</h2>: x" + format(getIBuyableEff(12)) + "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getIBuyableCost(12)) +
          " Incrementy</b><br>";
        let cformula =
          "<b><h2>Cost formula</h2>:<br>" +
          getIncBuyableFormulaText(12) +
          "</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.i.buyables[12].effectBase()) +
          "^x</b><br>";
        let end = shiftDown ? cformula + eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      cost(a) {
        ...
        return Decimal.pow(base1, x)
          .times(Decimal.pow(1.25, x.times(x)))
          .times(1e4);
      },
      effectBase() {
      ...
      canAfford() {
        return (
          player.i.points.gte(getIBuyableCost(12)) &&
          player.i.buyables[12].lt(5e5)
        );
      },
      total() {
      ...
      unlocked() {
        return hasIUpg(13) || hasUnlockedRow(3);
      }
    },
    13: {
      ...
      display() {
        ...
        if (layers.i.buyables[13].total().gt(scs))
          eform = eformbase + "^(sqrt(x*" + formatWhole(scs) + "))";

        let start = "<b><h2>Amount</h2>: " + getIBuyableFormat(13) + "</b><br>";
        let softcapped = layers.i.buyables[13]
          .total()
          .gt(getIStaminaSoftcapStart());
        let eff =
          "<b><h2>Effect</h2>: ^" +
          format(getIBuyableEff(13)) +
          (softcapped ? " (softcapped)" : "") +
          "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getIBuyableCost(13)) +
          " Incrementy</b><br>";
        let cformula =
          "<b><h2>Cost formula</h2>:<br>" +
          getIncBuyableFormulaText(13) +
          "</b><br>";
      ...
      cost(a) {
        ...
        if (!hasUpgrade("a", 14) && !hasUpgrade("pi", 32))
          ret = ret.times(
            Decimal.pow(b1, xcopy).times(Decimal.pow(1.25, xcopy.times(xcopy)))
          );

        return ret.times(Decimal.pow(base1, Decimal.pow(base2, x)));
      },
      effectBase() {
        let add = devSpeedUp ? 0.001 : 0;
        if (hasUpgrade("p", 43)) add += 0.001;
        if (hasUpgrade("p", 53)) add += 0.002;
        return (hasUpgrade("pi", 32) ? 1.07 : 1.05) + add;
      },
      effect() {
        let x = layers.i.buyables[13].total();
        let scs = getIStaminaSoftcapStart();
        if (!hasUpgrade("pi", 32) && x.gt(scs))
          x = x
            .div(scs)
            .pow(0.5)
            .times(scs);
      ...
      canAfford() {
        return (
          player.i.points.gte(getIBuyableCost(13)) &&
          player.i.buyables[13].lt(getStaminaMaximumAmount())
        );
      },
      total() {
      ...
      unlocked() {
        return hasIUpg(14) || hasUnlockedRow(3);
      }
    }
  },
  tabFormat: {
    Main: {
      content: [
        ...
        [
          "display-text",
          function() {
            return hasIUpg(24) && !hasAMUpgrade(13) && !hasUpgrade("pi", 32)
              ? "Your best incrementy is " + format(player.i.best)
              : "";
          }
        ],
        [
          ...
          function() {
            ...
            if (hasUpgrade("pi", 32))
              return (
                "The incrementy Stamina softcap start is " +
                formatWhole(getIStaminaSoftcapStart())
              );
            return (
              "You are gaining " +
              format(layers.i.getResetGain()) +
        ...
        [
          "display-text",
          function() {
            return layers.i.nextUpgradeText();
          }
        ],
        [
          "display-text",
          function() {
            return player.i.best
              ...
              .log10()
              .gt(9)
              ? "You cannot buy Incrementy Buyables past 500,000 (" +
                  formatWhole(getStaminaMaximumAmount()) +
                  " for Stamina)!"
              : "";
          }
        ],
    ...
    Details: {
      content: [
        ...
        [
          "display-text",
          function() {
            return getBuyableAmount("i", 13).gt(0)
              ? "It is then raised to a power from Incrementy Stamina"
              : "";
          }
        ],
        [
        ...
        [
          ...
          function() {
            return hasUpgrade("pi", 32)
              ? "The buffed formula makes the point to Incrementy synergy uncapped, but Stamina does not boost base Incrementy gain anymore"
              : "";
          }
        ]
      ],
      unlocked() {
        return (
          layers.am.layerShown() || hasUpgrade("pi", 32) || player.o.best.gt(0)
        );
      }
    }
  },
  doReset(layer) {
    ...
    if (!hasUpgrade("am", 13) && !hasUpgrade("o", 21))
...
addLayer("am", {
  ...
  effectDescription() {
    return (
      "which multiplies incrementy and point gain by " +
      formatWhole(layers.am.effect())
    );
  },
  getResetGain() {
  ...
  getGainMultPost() {
    ...
    x = x.times(layers.sp.effect()[1]);
    x = x.times(
      player.e.points.max(1).pow(layers.sp.challenges[21].rewardEffect())
    );
    if (hasUpgrade("sp", 21))
      x = x.times(player.a.points.max(1).pow(player.sp.upgrades.length));
    if (hasUpgrade("sp", 44))
      x = x.times(
        Decimal.pow(player.a.points.max(1), challengeCompletions("sp", 22))
      );
  ...
  prestigeButtonText() {
    ...
    let start =
      "Reset to gain " +
      formatWhole(gain) +
      " Antimatter (based on total buyable levels)<br>";
    let pre = layers.am.getGainMultPre();
    let exp = layers.am.getGainExp();
    let pst = layers.am.getGainMultPost();
    let nextAt = "";
  ...
  canReset() {
    return (
      layers.am.getResetGain().gt(0) &&
      !hasUpgrade("pi", 32) &&
      !hasAMUpgrade(21) &&
      layers.am.baseAmount().gte(layers.am.requires)
    );
  },
  update(diff) {
    if (hasUpgrade("pi", 32)) {
    ...
    if (hasAMUpgrade(21))
      player.am.points = player.am.points.plus(
        layers.am.getResetGain().times(diff)
      );
  },
  ...
  upgrades: {
    ...
    12: {
      title: "Plain",
      description:
        "Triple Incrementy gain, and keep the first row of Incrementy Upgrades",
      cost: new Decimal(2),
      unlocked() {
    ...
    13: {
      title: "Sale",
      description:
        "Unlock new I upgrades, keep them on AM reset, you can buy 100 Incrementy Buyables, and they don't cost Incrementy",
      cost: new Decimal(10),
      unlocked() {
    ...
    21: {
      title: "Coarse",
      description:
        "Remove the Antimatter prestige, but gain 100% of gain on reset per second",
  ...
  tabFormat: [
    ...
    [
      "display-text",
      function() {
        return hasAMUpgrade(21)
          ? "You are gaining " +
              format(layers.am.getResetGain()) +
    ...
    [
      ...
      "",
      function() {
        return hasAMUpgrade(21) ? { display: "none" } : {};
      }
    ],
    "blank",
    "upgrades",
  ...
  doReset(layer) {
    ...
    //upgrades
    let keep = [];
    if (!hasMilestone("a", 1) && !hasUpgrade("s", 14))
      player.am.upgrades = filter(player.am.upgrades, keep);
...
addLayer("a", {
  ...
  effect() {
    ...
    let eff2 = Decimal.add(2, a)
      .div(2)
      .pow(5);

    if (eff1.log10().gt(400))
      eff1 = eff1
        .log10()
        .div(4)
        .pow(200);
    if (eff2.log10().gt(200))
      eff2 = eff2
        .log10()
        .div(2)
        .pow(100);
  ...
  getResetGain() {
    ...
    let ret = Decimal.pow(10, gainexp)
      .times(layers.a.getGainMult())
      .floor();
  ...
  getGainMult() {
    ...
    x = x.times(
      player.q.points
        .max(10)
        .log10()
        .pow(layers.b.challenges[21].rewardEffect())
    );
    x = x.times(layers.sp.effect()[1]);
    if (hasUpgrade("pi", 22))
      x = x.times(
        Decimal.pow(player.s.points.plus(1), player.pi.upgrades.length)
      );
  ...
  prestigeButtonText() {
    ...
    let start =
      "Reset to gain " + formatWhole(gain) + " Amoeba (based on incrementy)";
    let nextAt = "";
    if (gain.lt(1000)) {
      nextAt =
        "<br>Next at " +
  ...
  canReset() {
    return (
      layers.a.getResetGain().gt(0) &&
      !hasUpgrade("pi", 32) &&
      !hasMilestone("a", 3) &&
      layers.a.baseAmount().gte(layers.a.requires)
    );
  },
  update(diff) {
    if (hasUpgrade("pi", 32)) {
    ...
    if (hasMilestone("a", 3))
      player.a.points = player.a.points.plus(
        layers.a.getResetGain().times(diff)
      );
  },
  ...
  milestones: {
    ...
    3: {
      ...
      effectDescription:
        "Remove the ability to prestige, but gain 100% of amoebas on prestige per second",
      done() {
    ...
    4: {
      ...
      effectDescription:
        "<b>Rite</b> buys 1000, and unlock Amoeba upgrades and Wave",
      done() {
  ...
  upgrades: {
    ...
    25: {
      title: "Flare",
      description:
        "Particle Acceleration base is multiplied by Neutrino Generation total levels",
  ...
  tabFormat: [
    ...
    [
      ...
      "",
      function() {
        return hasMilestone("a", 3) ? { display: "none" } : {};
      }
    ],
    "blank",
    "milestones",
  ...
  doReset(layer) {
    ...
    let milekeep = [];
    if (!hasUpgrade("s", 21))
      player.a.milestones = filter(player.a.milestones, milekeep);
...
addLayer("m", {
  ...
  prestigeButtonText() {
    ...
    let start =
      "Reset to gain " + formatWhole(gain) + " Matter (based on incrementy)";
    let nextAt = "";
    let mlt = layers.m.getGainMult();
    if (gain.lt(1000)) {
      nextAt =
  ...
  canReset() {
    return (
      layers.m.getResetGain().gt(0) &&
      hasChallenge("am", 12) &&
      !hasUpgrade("e", 14) &&
      !hasUpgrade("pi", 32) &&
      layers.m.baseAmount().gte(layers.m.requires)
    );
  },
  update(diff) {
    if (hasUpgrade("pi", 32)) {
    ...
    if (hasUpgrade("e", 14))
      player.m.points = player.m.points.plus(
        layers.m.getResetGain().times(diff)
      );
  ...
  challenges: {
    ...
    11: {
      ...
      challengeDescription:
        "Amoebas base effects are 1 and square root Incrementy gain",
    ...
    12: {
      name: "Creek",
      challengeDescription:
        "Amoebas and Antimatter base effects are 1 and cube root Incrementy gain",
  ...
  tabFormat: [
    ...
    [
      ...
      "",
      function() {
        return hasUpgrade("e", 14) ? { display: "none" } : {};
      }
    ],
    "blank",
    "milestones",
...
addLayer("e", {
  ...
  resource: "Energy",
  baseAmount() {
    return player.m.points.min(player.am.points);
  },
  branches: ["am", "m"],
  type: "custom",
  getResetGain() {
  ...
  upgrades: {
    ...
    12: {
      ...
      cost: new Decimal(1e4),
      effect() {
        let ret = player.e.points.plus(1).pow(0.5);
        if (ret.gt(1e200))
          ret = ret
            .log10()
            .div(2)
    ...
    14: {
      title: "Vile",
      description:
        "Remove the ability to Matter prestige, but get 100% of Matter upon prestige per second",
    ...
    33: {
      title: "Rose",
      description:
        "Remove the current Antimatter to Incrementy multiplier softcaps",
    ...
    15: {
      title: "Homophones?",
      description:
        "Base Incrementy Gain buyable effect is raised to the tenth power",
    ...
    45: {
      title: "You",
      description:
        "Each Neutrino Generation level past 100 boosts its base by .01 (capped at 10)",
      cost: new Decimal("1e439"),
      unlocked() {
        return (
          (getBuyableAmount("n", 12).gte(24) && hasUpgrade("e", 35)) ||
          hasUnlockedRow(3)
        );
      }
    },
  ...
  tabFormat: [
    ...
    [
      "display-text",
      "Energy generation is based on the least amount of Matter and Antimatter"
    ],
    [
      "display-text",
      function() {
...
addLayer("p", {
  ...
  getGainMult() {
    ...
    x = x.times(layers.sp.effect()[1]);
    if (hasUpgrade("s", 43)) x = x.times(player.i.points.max(1).pow(0.0001));
  ...
  update(diff) {
    ...
    if (player.p.time > 1) {
      ...
      if (
        (hasUpgrade("s", 25) || hasMilestone("o", 1)) &&
        !hasUpgrade("pi", 41)
      ) {
  ...
  upgrades: {
    ...
    23: {
      title: "Tide",
      description:
        "Each Gluon Upgrade adds .05 to the Neutrino Generation base",
      cost: new Decimal(2e96),
      unlocked() {
        return (
          getBuyableAmount("n", 11).gte(54) ||
          hasUpgrade("g", 34) ||
          hasUnlockedRow(3)
        );
      }
    ...
    33: {
      title: "Brews",
      description:
        "Unlock the third Particle Buyable and P Collision gives free levels to middle column Neutrino buyables",
    ...
    34: {
      title: "Bruise",
      description:
        "Particle Simulation gives free levels to right column Neutrino buyables and gain 1000x Neutrinos",
    ...
    25: {
      title: "Collision!",
      description:
        "Unlock the second Particle Buyable and P Acceleration gives free levels to left column Neutrino buyables",
    ...
    41: {
      title: "Fawn",
      description:
        "Each upgrade in this row allows the purchase of two more Incrementy Stamina levels",
    ...
    51: {
      title: "Fizz",
      description:
        "Each upgrade in this row allows the purchase of four more Incrementy Stamina levels",
  ...
  buyables: {
    ...
    11: {
      ...
      display() {
        let additional = "";
        if (layers.p.buyables[11].extra().gt(0))
          additional = "+" + formatWhole(layers.p.buyables[11].extra());
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(getBuyableAmount("p", 11)) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" +
          format(layers.p.buyables[11].effect()) +
          "<br> to Particles</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.p.buyables[11].cost()) +
          " Particles</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.p.buyables[11].effectBase()) +
          "^x</b><br>";
      ...
      cost(a) {
        ...
        return Decimal.pow(1e4, exp1)
          .times(Decimal.pow(10, exp2))
          .times(Decimal.pow(2, exp3))
          .times(Decimal.pow(2, 1024));
      },
      effectBase() {
        let base = new Decimal(100);
        if (hasUpgrade("a", 25))
          base = base.times(layers.n.buyables[11].total().max(1));
        if (hasUpgrade("b", 44))
          base = base.times(
            Decimal.pow(
              1.05,
      ...
      canAfford() {
        return (
          player.p.points.gte(layers.p.buyables[11].cost()) &&
          !hasUpgrade("pi", 41)
        );
      },
      buy() {
      ...
      buyMax(maximum) {
        ...
        var check = 0;
        while (
          player.p.points.gte(layers.p.buyables[11].cost(increment * 2)) &&
          increment < maximum
        ) {
          increment *= 2;
        }
        while (increment >= 1 && toSkip < maximum) {
          ...
          if (player.p.points.gte(layers.p.buyables[11].cost(check)))
            toSkip += increment;
          increment /= 2;
        }
      ...
      unlocked() {
        return (
          (hasUpgrade("p", 15) || hasUnlockedRow(3)) && !hasUpgrade("pi", 41)
        );
      }
    },
    12: {
      ...
      display() {
        let additional = "";
        if (layers.p.buyables[12].extra().gt(0))
          additional = "+" + formatWhole(layers.p.buyables[12].extra());
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(getBuyableAmount("p", 12)) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" +
          format(layers.p.buyables[12].effect()) +
          "<br> to Neutrinos and Quarks</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.p.buyables[12].cost()) +
          " Particles</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.p.buyables[12].effectBase()) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      cost(a) {
        ...
        return Decimal.pow(base1, exp1)
          .times(Decimal.pow(25, exp2))
          .times(Decimal.pow(2, exp3))
          .times(Decimal.pow(10, 311));
      },
      effectBase() {
        let base = new Decimal(1e7);
        if (hasUpgrade("b", 23))
          base = base.pow(1 + challengeCompletions("b", 12));
        return base;
      },
      effect() {
      ...
      canAfford() {
        return (
          player.p.points.gte(layers.p.buyables[12].cost()) &&
          !hasUpgrade("pi", 41)
        );
      },
      buy() {
      ...
      buyMax(maximum) {
        ...
        var check = 0;
        while (
          player.p.points.gte(layers.p.buyables[12].cost(increment * 2)) &&
          increment < maximum
        ) {
          increment *= 2;
        }
        while (increment >= 1 && toSkip < maximum) {
          check = toSkip + increment;
          if (player.p.points.gte(layers.p.buyables[12].cost(check)))
            toSkip += increment;
          increment /= 2;
        }
        if (toSkip > maximum) toSkip = maximum;
      ...
      unlocked() {
        return (
          (hasUpgrade("p", 25) || hasUnlockedRow(3)) && !hasUpgrade("pi", 41)
        );
      }
    },
    13: {
      ...
      display() {
        let additional = "";
        if (layers.p.buyables[13].extra().gt(0))
          additional = "+" + formatWhole(layers.p.buyables[13].extra());
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(getBuyableAmount("p", 13)) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" +
          format(layers.p.buyables[13].effect()) +
          "<br> to Matter and Neutrinos</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.p.buyables[13].cost()) +
          " Particles</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.p.buyables[13].effectBase()) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      cost(a) {
        ...
        return Decimal.pow(3e17, exp1)
          .times(Decimal.pow(1e4, exp2))
          .times(Decimal.pow(5, exp3))
          .times(Decimal.pow(10, 422).times(5));
      },
      effectBase() {
      ...
      canAfford() {
        return (
          player.p.points.gte(layers.p.buyables[13].cost()) &&
          !hasUpgrade("pi", 41)
        );
      },
      buy() {
      ...
      buyMax(maximum) {
        ...
        var check = 0;
        while (
          player.p.points.gte(layers.p.buyables[13].cost(increment * 2)) &&
          increment < maximum
        ) {
          increment *= 2;
        }
        while (increment >= 1 && toSkip < maximum) {
          check = toSkip + increment;
          if (player.p.points.gte(layers.p.buyables[13].cost(check)))
            toSkip += increment;
          increment /= 2;
        }
        if (toSkip > maximum) toSkip = maximum;
      ...
      unlocked() {
        return (
          (hasUpgrade("p", 33) || hasUnlockedRow(3)) && !hasUpgrade("pi", 41)
        );
      }
    }
  },
  ...
  layerShown() {
    return (
      player.i.best.gt(Decimal.pow(10, 11450)) ||
      hasUnlockedRow(3) ||
      player.p.best.gt(0)
    );
  },
  tabFormat: [
    ...
    [
      ...
      function() {
        return (
          "You are getting " +
          format(layers.p.getResetGain()) +
          " Particles per second (based on Incrementy, requires 1e11475)"
        );
      }
    ],
    [
      ...
      function() {
        ...
        return (
          "This maxes at " +
          formatWhole(a) +
          " seconds worth of production (" +
          format(layers.p.getResetGain().times(a)) +
          ")"
        );
      }
    ],
...
addLayer("n", {
  ...
  getPostExp() {
    let x = new Decimal(1);
    if (hasUpgrade("p", 53))
      x = x.times(Decimal.pow(2, player.p.upgrades.length));
  ...
  buyables: {
    ...
    11: {
      ...
      display() {
        let additional = "";
        if (layers.n.buyables[11].extra().gt(0))
          additional = "+" + getNExtraBuyableFormat(11);
        let start =
          "<b><h2>Amount</h2>: " +
          getNBuyableFormat(11) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" + format(getNBuyableEff(11)) + "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getNBuyableCost(11)) +
          " Neutrinos</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.n.buyables[11].effectBase()) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      ...
      effectBase() {
        ...
        if (hasUpgrade("g", 21)) ret = ret.plus(0.3);
      ...
      extra() {
        let ret = layers.n.buyables[12]
          .total()
          .plus(layers.n.buyables[21].total())
          .plus(layers.n.buyables[13].total())
          .plus(layers.n.buyables[31].total());
        if (hasUpgrade("g", 25)) ret = ret.plus(layers.n.buyables[13].total());
        else if (hasUpgrade("g", 15))
          ret = ret.plus(
            layers.n.buyables[13]
              .total()
              .div(3)
              .floor()
          );
    ...
    12: {
      ...
      display() {
        let additional = "";
        if (layers.n.buyables[12].extra().gt(0))
          additional = "+" + getNExtraBuyableFormat(12);
        let start =
          "<b><h2>Amount</h2>: " +
          getNBuyableFormat(12) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" + format(getNBuyableEff(12)) + "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getNBuyableCost(12)) +
          " Neutrinos</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.n.buyables[12].effectBase()) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      ...
      effectBase() {
        ...
        if (hasUpgrade("b", 22))
          ret = ret.plus(layers.b.challenges[11].rewardEffect().root(3));
      ...
      extra() {
        let ret = layers.n.buyables[22]
          .total()
          .plus(layers.n.buyables[13].total())
          .plus(layers.n.buyables[32].total());
      ...
      unlocked() {
        return player.n.buyables[11].gte(2) || hasUnlockedRow(3);
      }
    },
    13: {
      ...
      display() {
        let additional = "";
        if (layers.n.buyables[13].extra().gt(0))
          additional = "+" + getNExtraBuyableFormat(13);
        let start =
          "<b><h2>Amount</h2>: " +
          getNBuyableFormat(13) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" + format(getNBuyableEff(13)) + "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getNBuyableCost(13)) +
          " Neutrinos</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.n.buyables[13].effectBase()) +
          "^x (based on best Incrementy)</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      cost(a) {
      ...
      effectBase() {
        ...
        if (inChallenge("b", 12))
          ret = ret.pow(new Decimal(2).div(3 + challengeCompletions("b", 12)));
      ...
      extra() {
        let ret = layers.n.buyables[23]
          .total()
          .plus(layers.n.buyables[33].total());
      ...
      unlocked() {
        return player.n.buyables[11].gte(12) || hasUnlockedRow(3);
      }
    },
    21: {
      ...
      display() {
        let additional = "";
        if (layers.n.buyables[21].extra().gt(0))
          additional = "+" + getNExtraBuyableFormat(21);
        let start =
          "<b><h2>Amount</h2>: " +
          getNBuyableFormat(21) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" + format(getNBuyableEff(21)) + "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getNBuyableCost(21)) +
          " Neutrinos</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.n.buyables[21].effectBase()) +
          "^x (based on best Neutrinos)</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      cost(a) {
      ...
      extra() {
        let ret = layers.n.buyables[22]
          .total()
          .plus(layers.n.buyables[23].total())
          .plus(layers.n.buyables[31].total());
      ...
      unlocked() {
        return player.n.buyables[11].gte(5) || hasUnlockedRow(3);
      }
    },
    22: {
      ...
      display() {
        let additional = "";
        if (layers.n.buyables[22].extra().gt(0))
          additional = "+" + getNExtraBuyableFormat(22);
        let start =
          "<b><h2>Amount</h2>: " +
          getNBuyableFormat(22) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" + format(getNBuyableEff(22)) + "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getNBuyableCost(22)) +
          " Neutrinos</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.n.buyables[22].effectBase()) +
          "^x (based on best Neutrinos)</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      ...
      effectBase() {
        if (inChallenge("sp", 11)) return new Decimal(1);
        let ret = player.n.best
          .plus(10)
          .log10()
          .root(2);
        if (hasUpgrade("g", 32))
          ret = ret.plus(layers.n.buyables[11].total().div(100));
    ...
    23: {
      ...
      display() {
        let additional = "";
        if (layers.n.buyables[23].extra().gt(0))
          additional = "+" + getNExtraBuyableFormat(23);
        let start =
          "<b><h2>Amount</h2>: " +
          getNBuyableFormat(23) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" + format(getNBuyableEff(23)) + "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getNBuyableCost(23)) +
          " Neutrinos</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.n.buyables[23].effectBase()) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
    ...
    31: {
      ...
      display() {
        let additional = "";
        if (layers.n.buyables[31].extra().gt(0))
          additional = "+" + getNExtraBuyableFormat(31);
        let start =
          "<b><h2>Amount</h2>: " +
          getNBuyableFormat(31) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" + format(getNBuyableEff(31)) + "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getNBuyableCost(31)) +
          " Neutrinos</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.n.buyables[31].effectBase()) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      ...
      unlocked() {
        return player.n.buyables[11].gte(20) || hasUnlockedRow(3);
      }
    },
    32: {
      ...
      display() {
        let additional = "";
        if (layers.n.buyables[32].extra().gt(0))
          additional = "+" + getNExtraBuyableFormat(32);
        let start =
          "<b><h2>Amount</h2>: " +
          getNBuyableFormat(32) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" + format(getNBuyableEff(32)) + "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getNBuyableCost(32)) +
          " Neutrinos</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.n.buyables[32].effectBase()) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      ...
      effectBase() {
        ...
        let ret = new Decimal(100);
        if (hasUpgrade("s", 32))
          ret = ret.plus(layers.n.buyables[32].total().pow(3));
      ...
      extra() {
        ...
        if (hasUpgrade("p", 33)) ret = ret.plus(layers.p.buyables[12].total());
        if (hasUpgrade("b", 32))
          ret = ret.plus(challengeCompletions("b", 21) * 20);
        return ret;
      },
      buy() {
    ...
    33: {
      ...
      display() {
        let additional = "";
        if (layers.n.buyables[33].extra().gt(0))
          additional = "+" + getNExtraBuyableFormat(33);
        let start =
          "<b><h2>Amount</h2>: " +
          getNBuyableFormat(33) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: x" + format(getNBuyableEff(33)) + "</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(getNBuyableCost(33)) +
          " Neutrinos</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.n.buyables[33].effectBase()) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
  ...
  tabFormat: [
    ...
    [
      ...
      function() {
        return (
          "You are getting " +
          format(layers.n.getResetGain()) +
          " Neutrinos per second (based on particles)"
        );
      }
    ],
    [
      "display-text",
      "Each buyable has an effect and gives a free level to all upgrades directly to the left or above it"
    ],
    "blank",
    "blank",
    "buyables"
...
addLayer("g", {
  ...
  upgrades: {
    ...
    14: {
      title: "Billed",
      description:
        "Add two free levels to Base Incrementy Gain Neutrino buyable",
    ...
    32: {
      title: "Mussel",
      description:
        "Each Neutrino Generation Buyable adds .01 to the Particle Boost buyable base",
    ...
    33: {
      title: "Read",
      description:
        "Each Gluon Upgrades adds .25 to the Particle Boost buyable base",
    ...
    34: {
      title: "Reed",
      description:
        "Each Incrementy Strength adds .1 to the Energy Boost buyable base",
    ...
    41: {
      title: "Read?",
      description:
        "Matter Gain buyables also give free levels to Particle Generation",
    ...
    44: {
      title: "Idol",
      description:
        "Amoeba Gain buyables also give free levels to Particle Boost",
    ...
    52: {
      title: "Mote",
      description:
        "Antimatter Gain buyables also gives free levels to Incrementry Boost",
    ...
    53: {
      title: "Blue",
      description:
        "Antimatter Gain buyables also gives free levels to Base Incrementy Gain",
    ...
    54: {
      title: "Blew",
      description:
        "Amoeba Gain buyables boost its effect base and give free levels to Particle Generation",
    ...
    15: {
      title: "How",
      description:
        "Every third Base Incrementy Gain buyable gives an additional free level to Neutrino Generation",
    ...
    25: {
      title: "Do",
      description:
        "The above upgrade gives free additional levels to Neutrino Generation no matter what",
    ...
    35: {
      title: "We",
      description:
        "Each upgrade in this column gives a free Energy Boost buyable",
    ...
    45: {
      title: "Name",
      description:
        "Amoeba Gain buyables give free Neutrino Generation buyables",
  ...
  tabFormat: [
    ...
    [
      ...
      function() {
        return (
          "You are getting " +
          format(layers.g.getResetGain()) +
          " Gluons per second (based on particles)"
        );
      }
    ],
    "blank",
  ...
  tabFormat: [
    ...
    [
      ...
      function() {
        return (
          "You are getting " +
          format(layers.q.getResetGain()) +
          " Quarks per second (based on particles)"
        );
      }
    ],
    [
      ...
      function() {
        return (
          "Your Quark amount raises Quark challenge goals to the power of " +
          format(layers.q.getChallGoalExp(), 6)
        );
      }
    ],
    "blank",
...
addLayer("s", {
  ...
  effect() {
    ...
    if (amt.lt(1) && player.s.best.plus(player.sp.best).gte(1))
      amt = new Decimal(1);
  ...
  effectDescription() {
    let a =
      "which multiplies incrementy gain by " +
      formatWhole(layers.s.effect()) +
      ".";
    let b =
      " The effect is always at least 10,000 once you have Shard reset once";
  ...
  getGainMultPost() {
    let x = new Decimal(1);
    if (hasUpgrade("s", 34))
      x = x.times(Decimal.pow(2, layers.n.buyables[33].extra()));
    x = x.times(layers.sp.effect()[1]);
    if (hasUpgrade("s", 44))
      x = x.times(
        player.i.points
    ...
    if (hasUpgrade("sp", 33))
      x = x.times(
        Decimal.pow(player.sp.points.max(1), challengeCompletions("sp", 21))
      );
  ...
  update(diff) {
    ...
    if (hasUpgrade("s", 31))
      player.s.points = player.s.points.plus(
        layers.s.getResetGain().times(diff)
      );
  },
  upgrades: {
    rows: 5,
    ...
    11: {
      title: "Lead",
      description:
        "Gain a free Incrementy Stamina level, 10x Antimatter, and 2x Neutrinos",
      cost: new Decimal(1),
      unlocked() {
        return true;
      }
    ...
    12: {
      title: "Led",
      description:
        "Gain a free Incrementy Stamina level, gain 100x Matter and Amoeba, and Shard upgrades multiply Neutrino gain",
      cost: new Decimal(1),
      unlocked() {
        return true;
      }
    ...
    13: {
      title: "Lynx",
      description:
        "Add one to the base of Neutrino Generation and Incrementy Speed, make particle gain 100x faster but cap it at 1 second",
      cost: new Decimal(1),
      unlocked() {
        return (
          (hasUpgrade("s", 12) && hasUpgrade("s", 11)) || hasUnlockedRow(4)
        );
      }
    },
    14: {
      title: "Links",
      description:
        "Keep challenges and upgrades from AM, M, and Q, and buy one of each Neutrino Buyables every second",
      cost: new Decimal(1),
      unlocked() {
    ...
    21: {
      title: "Alter",
      description:
        "Keep P and E upgrades and A milestones, add 1 to Particle per second production",
      cost: new Decimal(4),
      unlocked() {
    ...
    22: {
      title: "Wain",
      description:
        "Each Shard Upgrade gives a free level to each Incrementy buyable",
      cost: new Decimal(6),
      unlocked() {
    ...
    23: {
      title: "Wane",
      description:
        "Particle Simulation levels raise its base to its amount, Particle Simulation effects Gluons, and Links can buy 10",
      cost: new Decimal(8),
      unlocked() {
    ...
    25: {
      title: "Wrap",
      description:
        "Particle Boost give levels to Neutrino Gain and automatically buy Particle Upgrades once per second",
      cost: new Decimal(20),
      unlocked() {
    ...
    31: {
      title: "Wring",
      description:
        "Remove the ability to Shard Prestige but gain 100% of Shards on prestige per second",
      cost: new Decimal(50),
      unlocked() {
    ...
    33: {
      title: "Lapse",
      description:
        "Cube Shard gain and Particle Simulation gives free levels to Particle Accerelation",
      cost() {
    ...
    34: {
      title: "Laps",
      description:
        "Each extra Amoeba Gain buyable doubles Shard gain and Particle Collision gives free levels to Particle Accerelation",
      cost: new Decimal(3e5),
      unlocked() {
    ...
    35: {
      title: "Help?",
      description:
        "Particle Simulation gives free levels to Particle Collision and begin generation of Bosons",
    ...
    41: {
      title: "Hoard",
      description:
        "Links and Wrap buy ten and four times more and double Super Prestige point gain",
      cost: new Decimal(1e69),
      unlocked() {
        return (
          (hasUpgrade("s", 35) && hasMilestone("sp", 5)) ||
          hasUpgrade("s", 41) ||
          hasUnlockedRow(4)
        );
      }
    ...
    42: {
      title: "Horde",
      description:
        "Cube Super Prestige Point gain and each Shard upgrade pushes Incrementy Stamina softcap back by 1",
      cost: new Decimal(50),
    ...
    43: {
      title: "Forth",
      description:
        "Incrementy raised to .01% multiplies Particle gain and cube base Shard gain",
      cost: new Decimal(50),
      currencyDisplayName: "Super Prestige Points",
      currencyInternalName: "points",
      currencyLayer: "sp",
    ...
    45: {
      title: "Ceiling",
      description:
        "The previous upgrade works at 1% of the rate for Super Prestige Points",
    ...
    55: {
      title: "Devisor",
      description:
        "<b>Rite</b> can buy ten times more and unlock Obfuscations if you have Super Prestige Reset 25 times",
    ...
    [
      ...
      function() {
        return hasUpgrade("s", 31)
          ? "You are getting " +
              format(layers.s.getResetGain()) +
              " Shards per second (based on particles)"
          : "";
      }
    ],
    [
      ...
      "",
      function() {
        return hasUpgrade("s", 31) ? { display: "none" } : {};
      }
    ],
    "blank",
    "upgrades"
...
addLayer("b", {
  ...
  effectDescription() {
    let a =
      "which multiplies Incrementy gain by Amoebas ^" +
      format(layers.b.effect()) +
      ".";
    return a;
  },
  getResetGain() {
  ...
  getGainExp() {
    ...
    if (hasUpgrade("b", 14))
      x = x.times(Decimal.pow(getBChallengeTotal(), 0.5).max(1));
    if (hasUpgrade("o", 12)) x = x.times(1.001);
    return x;
  },
  getGainMultPre() {
  ...
  tokenGain() {
    ...
    if (hasUpgrade("b", 13))
      ret = ret.times(Decimal.pow(2, getBChallengeTotal()));
    if (hasUpgrade("b", 24))
      ret = ret.times(Decimal.pow(2, getBChallengeTotal()));
    if (hasUpgrade("b", 21))
      ret = ret.times(Decimal.max(1, challengeCompletions("b", 11)));
  ...
  challenges: {
    ...
    11: {
      name: "Been",
      challengeDescription:
        "Incrementy Stamina effect is linear instead of exponential",
      rewardDescription:
        "Add to the base of Incrementy Strength and Neutrino generation based on total Boson Challenge completions",
      rewardEffect() {
      ...
      rewardDisplay() {
        let comps =
          "Because you have " +
          formatWhole(challengeCompletions("b", 11)) +
          " challenge completions, ";
        let eff =
          "add " +
          format(layers.b.challenges[11].rewardEffect()) +
          " to the base.";
        return comps + eff;
      },
      unlocked() {
      ...
      goal() {
        ...
        if (hasMilestone("o", 0))
          base *= Math.pow(0.98, player.o.milestones.length);
    ...
    12: {
      ...
      challengeDescription() {
        return (
          "Base Incrementy Gain buyable base is raised to the " +
          format(new Decimal(2).div(3 + challengeCompletions("b", 12)), 3)
        );
      },
      rewardDescription:
        "Incrementy Stamina gives free levels to Incrementy Speed",
      rewardEffect() {
      ...
      rewardDisplay() {
        let comps =
          "Because you have " +
          formatWhole(challengeCompletions("b", 12)) +
          " challenge completions, ";
        let eff =
          "you get " +
          format(layers.b.challenges[12].rewardEffect()) +
          " free Speed levels per Stamina.";
        return comps + eff;
      },
      unlocked() {
    ...
    21: {
      ...
      rewardDescription:
        "Log10 of your Quarks raised to a power boosts Amoeba gain",
      rewardEffect() {
      ...
      rewardDisplay() {
        let comps =
          "Because you have " +
          formatWhole(challengeCompletions("b", 21)) +
          " challenge completions, ";
        let eff =
          "you get a log(Quarks)^" +
          format(layers.b.challenges[21].rewardEffect()) +
          " multiplier to Amoeba gain.";
        return comps + eff;
      },
      unlocked() {
      ...
      goal() {
        ...
        if (devSpeedUp) base = Math.floor(base ** 0.995);
    ...
    22: {
      ...
      rewardDescription:
        "Add to the Particle Generation base, and get extra Particle Simulation levels",
      rewardEffect() {
      ...
      rewardDisplay() {
        let comps =
          "Because you have " +
          formatWhole(challengeCompletions("b", 22)) +
          " challenge completions, ";
        let eff =
          "you get +" +
          format(layers.b.challenges[22].rewardEffect()[0]) +
          " to the Particle Generation base and ";
        let eff2 =
          formatWhole(layers.b.challenges[22].rewardEffect()[1]) +
          " extra Particle Simulation levels.";
  ...
  upgrades: {
    ...
    11: {
      title: "Few",
      description:
        "Uncap Hall and Incrementy Stamina gives free levels to Incrementy Boost",
      cost: new Decimal(30),
    ...
    12: {
      title: "Phew",
      description:
        "Been completions add to the Amoeba Gain base and give free Amoeba Gain levels",
      cost: new Decimal(300),
      currencyDisplayName: "Tokens",
      currencyInternalName: "tokens",
      currencyLayer: "b",
    ...
    13: {
      title: "Maze",
      description:
        "Push the Boson softcap to 20, each challenge completion doubles token gain, and unlock the second challenge",
      cost: new Decimal(1000),
      currencyDisplayName: "Tokens",
      currencyInternalName: "tokens",
      currencyLayer: "b",
    ...
    14: {
      title: "Maize",
      description:
        "Boson gain is rasied to the square root of Boson Challenge completions",
    ...
    21: {
      title: "Load",
      description:
        "Been Completions give Particle Collision levels and multiply token gain",
      ...
      unlocked() {
        return (
          (hasUpgrade("b", 14) && getBChallengeTotal() >= 7) ||
          hasUnlockedRow(4)
        );
      }
    },
    ...
    23: {
      title: "Born",
      description:
        "Raise Particle Collision base to 1 + Bin completions and <b>Rite</b> buys 5,000",
    ...
    24: {
      title: "Borne",
      description:
        "Bin completions give free Particle Simulation levels and each Boson Challenge doubles token gain",
      cost: new Decimal(1e8),
      currencyDisplayName: "Tokens",
      currencyInternalName: "tokens",
      currencyLayer: "b",
    ...
    33: {
      title: "Dew",
      description:
        "Been completions give free Particle Simulation levels and unlock the fourth challenge",
      cost: new Decimal(1e17),
      currencyDisplayName: "Tokens",
      currencyInternalName: "tokens",
      currencyLayer: "b",
    ...
    41: {
      title: "Rye",
      description:
        "Band completions give Particle Collision levels and Particle Collision effects Antimatter gain",
    ...
    43: {
      title: "Throne",
      description:
        "Each Banned completion increases the Incrementy Stamina softcap start by one",
    ...
    44: {
      title: "Thrown",
      description:
        "Multiplicatively increase the P Acceleration base by 5% per Banned completion per P Simulation level",
    ...
    Challenges: {
      content: [
        ...
        [
          ...
          function() {
            let a =
              "Gain is based Particles. Starting challenges resets Bosons and Incrementy.";
            let b =
              "<br>You are getting " +
              format(layers.b.getResetGain()) +
              " Bosons per second";
    ...
    Upgrades: {
      content: [
        [
          ...
          function() {
            let a =
              "You have <h3>" + formatWhole(player.b.tokens) + "</h3> tokens";
            return a;
          }
        ],
        [
...
addLayer("sp", {
  ...
  effectDescription() {
    ...
    let a =
      "which increases the Incrementy Stamina softcap by " +
      formatWhole(eff[0]) +
      " (";
    let c = eff[0].plus(1);
    ...
    let b =
      ") and all previous prestige resources by " +
      format(eff[1]) +
      " (based on best Super Prestige Points).";
    return a + mid + b;
  },
  getResetGain() {
  ...
  getGainMultPre() {
    let x = new Decimal(1);
    if (devSpeedUp)
      x = x.times(Decimal.pow(1.5, Math.sqrt(player.sp.upgrades.length + 1)));
    return x;
  },
  getGainMultPost() {
    let x = new Decimal(1);
    ...
    if (hasUpgrade("sp", 32))
      x = x.times(Decimal.pow(50, challengeCompletions("sp", 22)));
    ...
    if (hasMilestone("pi", 3))
      x = x.times(Decimal.pow(2, player.pi.upgrades.length ** 2));
    if (hasUpgrade("pi", 21))
      x = x.times(
        Decimal.pow(player.pi.points.plus(1), player.pi.upgrades.length)
      );
  ...
  prestigeButtonText() {
    ...
    let start =
      "Reset to gain " + formatWhole(gain) + " Super Prestige Points<br>";
    let pre = layers.sp.getGainMultPre();
    let exp = layers.sp.getGainExp();
    let pst = layers.sp.getGainMultPost();
    let nextAt =
  ...
  canReset() {
    return (
      layers.sp.getResetGain().gt(0) &&
      (getBChallengeTotal() >= 40 ||
        player.sp.best.gt(0) ||
        hasUnlockedRow(4)) &&
      !hasUpgrade("sp", 12)
    );
  ...
  update(diff) {
    ...
    if (hasUpgrade("sp", 12)) {
      player.sp.points = player.sp.points.plus(
        layers.sp.getResetGain().times(diff)
      );
      player.sp.total = player.sp.total.plus(
        layers.sp.getResetGain().times(diff)
      );
      player.sp.time += diff;
      if (player.sp.time > 1) {
  ...
  milestones: {
    1: {
      requirementDescription:
        "<b>Toad</b><br>Requires: 2 Total Super Prestige Points",
    ...
    2: {
      requirementDescription:
        "<b>Toed</b><br>Requires: 3 Total Super Prestige Points",
    ...
    3: {
      requirementDescription:
        "<b>Towed</b><br>Requires: 5 Total Super Prestige Points",
      effectDescription:
        "Raise token generation to the 1.1th power and then multiply it by 10",
      done() {
    ...
    4: {
      requirementDescription:
        "<b>Wait</b><br>Requires: 8 Total Super Prestige Points",
    ...
    5: {
      requirementDescription:
        "<b>Weight</b><br>Requires: 13 Total Super Prestige Points",
  ...
  challenges: {
    ...
    getPointGain() {
      if (inChallenge("sp", 11)) {
        ...
        let diff = player.points
          .max(10)
          .log(10)
          .max(2)
          .log(2)
          .minus(base.log(10).log(2))
          .max(0);
        return diff
          .plus(1)
          .pow(3)
    ...
    11: {
      ...
      rewardDisplay() {
        let comps =
          "Because you have " +
          formatWhole(player.sp.chall1points) +
          " Challenge Points ";
        comps +=
          "and " +
          formatWhole(challengeCompletions("sp", 11)) +
          " Challenge completions, ";
        let eff =
          "you get " +
          format(layers.sp.challenges[11].rewardEffect()) +
          "x Super Prestige Points.";
        return comps + eff;
      },
      unlocked() {
    ...
    12: {
      ...
      rewardDisplay() {
        let comps =
          "Because you have " +
          formatWhole(player.sp.chall2points) +
          " Challenge Points, ";
        comps +=
          "and " +
          formatWhole(challengeCompletions("sp", 12)) +
          " Challenge completions, ";
        let eff =
          "you get " +
          format(layers.sp.challenges[12].rewardEffect()) +
          "x Shard gain.";
        return comps + eff;
      },
      unlocked() {
    ...
    21: {
      ...
      rewardDescription:
        "Challenge Points boost Energy to Antimatter Synergy<br>",
      rewardEffect() {
        ...
        let effpts = pts.pow(1 - 0.8 / Math.sqrt(comps));
        let ret = Decimal.minus(
          Decimal.div(1, effpts.plus(10).log10()),
          1
        ).times(-1);

        if (hasUpgrade("sp", 42)) ret = ret.sqrt();
        if (hasUpgrade("pi", 23))
          ret = ret.pow(Decimal.pow(0.8, player.pi.milestones.length));
        return ret;
      },
      rewardDisplay() {
        let comps =
          "Because you have " +
          formatWhole(player.sp.chall3points) +
          " Challenge Points, ";
        comps +=
          "and " +
          formatWhole(challengeCompletions("sp", 21)) +
          " Challenge completions, ";
        let eff =
          "Energy^" +
          format(layers.sp.challenges[21].rewardEffect(), 4) +
          " boosts Antimatter gain.";
        return comps + eff;
      },
      unlocked() {
        return !hasUpgrade("pi", 32) && player.sp.times >= 25;
    ...
    22: {
      ...
      rewardDisplay() {
        let comps =
          "Because you have " +
          formatWhole(player.sp.chall4points) +
          " Challenge Points, ";
        comps +=
          "and " +
          formatWhole(challengeCompletions("sp", 22)) +
          " Challenge completions, ";
        let eff =
          "you get x" +
          format(layers.sp.challenges[22].rewardEffect()) +
          " to Particle Boost base.";
        return comps + eff;
      },
      unlocked() {
        return !hasUpgrade("pi", 32) && player.sp.times >= 25;
  ...
  upgrades: {
    ...
    11: {
      ...
      effect() {
        ...
        let ret = Decimal.pow(amt, Decimal.log10(amt).pow(-0.5));
      ...
      unlocked() {
        return (
          hasUpgrade("sp", 11) ||
          player.sp.chall1points.gte(360) ||
          hasUnlockedRow(4)
        );
      }
    },
    12: {
      title: "Loot",
      description:
        "Remove the ability to Prestige but gain 100% of SP Points on prestige and one SP time per second",
    ...
    13: {
      title: "Earn",
      description:
        "Each Super Prestige Upgrade pushes the Incrementy Stamina Softcap Start back by one",
    ...
    14: {
      ...
      effect() {
        let ret = player.sp.chall2points.plus(1).pow(0.5);
    ...
    21: {
      title: "Ate",
      description:
        "Each Super Prestige upgrade makes Amoebas multiply Antimatter",
      cost: new Decimal(400),
    ...
    22: {
      title: "Eight",
      description:
        "Each Jewel completion pushes the Incrementy Stamina Softcap back by one",
    ...
    32: {
      title: "Sea",
      description:
        "Each Joule Completion boosts Super Prestige point gain by 50x",
    ...
    33: {
      title: "Add",
      description:
        "Each Jewel Completion multiplies Shard gain by Super Prestige Points",
    ...
    44: {
      title: "Owed",
      description:
        "Each Joule Completion makes Amoebas multiply Antimatter gain",
    ...
    15: {
      title: "Bale",
      description:
        "Each Upgrade in this column multiplies Super Prestige point gain by Quartz completions",
    ...
    51: {
      title: "Schwartz",
      description:
        "Each Super Prestige upgrade in this row raises Incrementy gain to the 1.2",
    ...
    53: {
      title: "Kodaira",
      description:
        "Add 3 to the limit of Incrementy Stamina per Super Prestige upgrade",
  ...
  layerShown() {
    return (
      getBChallengeTotal() >= 40 || player.sp.best.gt(0) || hasUnlockedRow(4)
    );
  },
  tabFormat: {
    QoL: {
      content: [
        ...
        [
          ...
          function() {
            return (
              ...
              formatWhole(player.sp.times) +
              " Super Prestige resets"
            );
          }
        ],
        [
          ...
          function() {
            ...
            return (
              "You have gotten a total of " +
              formatWhole(player.sp.total) +
        ...
        [
          ...
          function() {
            if (!hasUpgrade("sp", 12))
              return "Super Prestige resets Shard and all prior layers";
            return (
              "You are gaining " +
              format(layers.sp.getResetGain()) +
              " Super Prestige Points per second"
            );
          }
        ],
        [
          "display-text",
          function() {
            if (player.sp.times < 25 && hasMilestone("sp", 5))
              return "Get 25 Super Prestige resets to continue progressing";
            return "";
          }
        ],
        [
          ...
          "",
          function() {
            return hasUpgrade("sp", 12) ? { display: "none" } : {};
          }
        ],
        "milestones"
      ],
    ...
    Obfuscations: {
        ...
        [
          ...
          function() {
            if (
              ...
              let a =
                "Leaving the challenge will give " +
                formatWhole(gain) +
                " Challenge Points";
              let b = "";
              if (gain.lt(1000)) {
                ...
                if (inChallenge("sp", 11))
                  init = init.max(player.sp.chall1points);
                if (inChallenge("sp", 12))
                  init = init.max(player.sp.chall2points);
                if (inChallenge("sp", 21))
                  init = init.max(player.sp.chall3points);
                if (inChallenge("sp", 22))
                  init = init.max(player.sp.chall4points);
                ...
                if (
                  ...
                  target = Decimal.pow(100, target.minus(1));

                let add = new Decimal(0);
                if (inChallenge("sp", 11))
                  add = layers.sp.challenges[11]
                    .goal(true)
                    .log(10)
                    .log(2);
                if (inChallenge("sp", 12))
                  add = layers.sp.challenges[12]
                    .goal(true)
                    .log(10)
                    .log(2);
                if (inChallenge("sp", 21))
                  add = layers.sp.challenges[21]
                    .goal(true)
                    .log(10)
                    .log(2);
                if (inChallenge("sp", 22))
                  add = layers.sp.challenges[22]
                    .goal(true)
                    .log(10)
                    .log(2);
      ...
      unlocked() {
        return (
          hasUpgrade("s", 55) && !hasUpgrade("pi", 32) && player.sp.times >= 25
        );
      }
    },
    Upgrades: {
      content: ["main-resouce-display", "upgrades"],
      unlocked() {
        return (
          hasUpgrade("sp", 11) ||
          player.sp.chall1points.gte(360) ||
  ...
  doReset(layer) {
    ...
    if (layer == "pi") return;
    let keep = [];
    if (hasMilestone("o", 5) || hasMilestone("c", 5))
      keep.push(
        11,
        12,
        13,
    ...
    if (hasMilestone("o", 6) || hasUpgrade("c", 12))
      keep.push(51, 52, 53, 54, 55);
...
addLayer("pi", {
  ...
  effectDescription() {
    ...
    let a =
      "which increases the Incrementy Stamina softcap by " + formatWhole(eff);
    let b = "";
  ...
  getGainExp() {
    let x = new Decimal(0.2339);
    if (devSpeedUp) x = new Decimal(0.25);
  ...
  getGainMultPost() {
    ...
    if (hasUpgrade("pi", 24))
      x = x.times(Decimal.sqrt(player.pi.upgrades.length).max(1));
    return x;
  },
  prestigeButtonText() {
  ...
  canReset() {
    return (
      layers.pi.getResetGain().gt(0) &&
      !hasMilestone("pi", 5) &&
      (player.sp.upgrades.length >= 20 || player.c.best.gt(0))
    );
  },
  update(diff) {
  ...
  milestones: {
    1: {
      ...
      effectDescription:
        "Each milestone makes the Incrementy Stamina softcap start 2 later",
      done() {
    ...
    3: {
      ...
      effectDescription:
        "Double Super Prestige Point gain per Pion upgrade squared",
      done() {
    ...
    4: {
      requirementDescription:
        "<b>Mantel</b><br>Requires: 24 Pions in one reset",
    ...
    5: {
      requirementDescription:
        "<b>Mantle</b><br>Requires: 120 Pions in one reset",
      effectDescription:
        "You gain 100% of your pions on reset per second, and your best Pions per reset is likewise updated",
      done() {
  ...
  upgrades: {
    ...
    11: {
      ...
      unlocked() {
        return (
          hasMilestone("pi", 2) || hasUpgrade("pi", 11) || player.c.best.gt(0)
        );
      }
    },
    12: {
      title: "Be",
      description:
        "Each Pion upgrade multiplies Super Prestige Point gain by Joule challenge points",
      cost: new Decimal(10),
      effect() {
        return Decimal.pow(
          player.sp.chall1points.plus(1),
          player.pi.upgrades.length
        );
      },
      unlocked() {
    ...
    13: {
      title: "Beat",
      description:
        "Each Pion upgrade pushes the Incrementy Stamina Softcap back by 1",
      cost: new Decimal(15),
      unlocked() {
    ...
    21: {
      title: "Feat",
      description:
        "Each Pion upgrade multiplies Super Prestige Point gain by Pions",
    ...
    22: {
      title: "Feet",
      description:
        "Each Pion upgrade makes Shards multiply Amoeba gain and multiply Pion gain by 1.8",
    ...
    32: {
      title: "Seen",
      description:
        "You can no longer access or gain AM, A, E, M, Q, B or G or SP challenges but vastly buff the Incrementy gain formula",
    ...
    33: {
      title: "Steak",
      description:
        "Pion upgrades after the first ten push back the Incrementy Stamina Maximum amount by 10",
    ...
    43: {
      ...
      unlocked() {
        return (
          hasUpgrade("sp", 55) ||
          hasUpgrade("pi", 43) ||
          (hasUpgrade("pi", 32) && player.o.best.gt(0)) ||
          player.c.best.gt(0)
        );
      }
    },
  ...
  layerShown() {
    return (
      player.sp.best.gt(1e132) || player.pi.best.gt(0) || hasUnlockedRow(4)
    );
  },
  tabFormat: {
    Milestones: {
      content: [
        ...
        [
          ...
          "",
          function() {
            return hasMilestone("pi", 5) ? { display: "none" } : {};
          }
        ],
        [
          "display-text",
...
addLayer("o", {
  ...
  effectDescription() {
    ...
    let a =
      "which increases Tokens and Neutrino gain by " +
      format(eff) +
      " (based on total Origins)";
  ...
  getGainMultPost() {
    ...
    if (hasUpgrade("f", 12))
      x = x.times(
        Decimal.pow(player.f.points.plus(1), player.f.upgrades.length)
      );
  ...
  buyables: {
    ...
    11: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.o.buyables[11]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: ^" +
          format(layers.o.buyables[11].effect(), 4) +
          " to Incrementy</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.o.buyables[11].cost()) +
          " Origins</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.o.buyables[11].effectBase(), 3) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      ...
      effectBase() {
        ...
        if (hasUpgrade("o", 31))
          base = base.plus(layers.o.buyables[11].total().times(0.001));
        if (hasUpgrade("o", 45))
          base = base.plus(layers.o.buyables[32].total().times(0.1));
        return base;
      },
      effect() {
    ...
    12: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.o.buyables[12]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: ^" +
          format(layers.o.buyables[12].effect(), 4) +
          " to Pions</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.o.buyables[12].cost()) +
          " Origins</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.o.buyables[12].effectBase(), 3) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      ...
      effectBase() {
        let base = new Decimal(1.02);
        if (hasUpgrade("o", 32))
          base = base.plus(layers.o.buyables[12].total().times(0.002));
        if (hasUpgrade("f", 13))
          base = base.plus(
            layers.o.buyables[33]
              .total()
              .times(player.f.upgrades.length)
              .div(100)
          );
    ...
    13: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.o.buyables[13]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: " +
          formatWhole(layers.o.buyables[13].effect()) +
          " Free Stamina Levels</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.o.buyables[13].cost()) +
          " Origins</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br> x" +
          (layers.o.buyables[13].total().gt(10) ? "*10" : "^2") +
          "</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      cost(a) {
        ...
        let base2 = 1.5;
        let exp2 = x.times(x);
        return Decimal.pow(base2, exp2)
          .times(Decimal.pow(base1, x))
          .ceil();
      },
      effectBase() {
        let base = new Decimal(1.02);
    ...
    21: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.o.buyables[21]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: ^" +
          format(layers.o.buyables[21].effect(), 4) +
          " Particle Gain</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.o.buyables[21].cost()) +
          " Origins</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.o.buyables[21].effectBase(), 3) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      ...
      effectBase() {
        ...
        if (hasUpgrade("o", 51))
          base = base.plus(layers.o.buyables[23].total().div(10));
        return base;
      },
      effect() {
    ...
    22: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.o.buyables[22]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: ^" +
          format(layers.o.buyables[22].effect(), 4) +
          " Super Prestige Point gain</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.o.buyables[22].cost()) +
          " Origins</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.o.buyables[22].effectBase(), 3) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      ...
      extra() {
        ...
        ret = ret.plus(layers.o.buyables[32].total());
        if (hasUpgrade("o", 44))
          ret = ret.plus(layers.o.buyables[31].total().times(3));
    ...
    23: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.o.buyables[23]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: *" +
          format(layers.o.buyables[23].effect()) +
          " Origin gain</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.o.buyables[23].cost()) +
          " Origins</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.o.buyables[23].effectBase(), 3) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
      ...
      effectBase() {
        let base = new Decimal(2);
        if (hasUpgrade("o", 43))
          base = base.plus(layers.o.buyables[11].total().div(100));
        return base;
      },
      effect() {
    ...
    31: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.o.buyables[31]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: ^" +
          format(layers.o.buyables[31].effect(), 4) +
          " Neutrino Gain</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.o.buyables[31].cost()) +
          " Origins</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.o.buyables[31].effectBase(), 3) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
    ...
    32: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.o.buyables[32]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: ^" +
          format(layers.o.buyables[32].effect(), 4) +
          " Shard gain</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.o.buyables[32].cost()) +
          " Origins</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.o.buyables[32].effectBase(), 3) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
    ...
    33: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.o.buyables[33]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: *" +
          format(layers.o.buyables[33].effect()) +
          " Base Origins</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.o.buyables[33].cost()) +
          " Origins</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.o.buyables[33].effectBase(), 3) +
          "^x</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
  ...
  upgrades: {
    ...
    12: {
      title: "Douglas",
      description:
        "Multiply all higher row prestige resource gain exponents by 1.001",
      cost: new Decimal(1),
      unlocked() {
    ...
    13: {
      title: "Grothendieck",
      description:
        "Multiply Super Prestige gain and effect by 2 and gain 5x more SP resets",
      cost: new Decimal(1),
      unlocked() {
    ...
    14: {
      title: "Baker",
      description:
        "Each Origin reset allows you to keep two more Shard upgrades and gain a free Incrementy Stamina level",
      cost: new Decimal(2),
      unlocked() {
    ...
    21: {
      title: "Novikov",
      description:
        "Keep π upgrades, π milestones, I upgrades, and multiply Origin gain by 1.5",
      cost: new Decimal(5),
      unlocked() {
    ...
    22: {
      title: "Mumford",
      description:
        "Unlock another buyable and Incrementy autobuyers can buy 25x faster",
      cost: new Decimal(5),
      unlocked() {
        return (
          (hasUpgrade("o", 21) && getBuyableAmount("o", 11).gte(3)) ||
          player.c.best.gt(0)
        );
      }
    },
    23: {
      ...
      unlocked() {
        return (
          (hasUpgrade("o", 22) && getBuyableAmount("o", 12).gte(2)) ||
          player.c.best.gt(0)
        );
      }
    },
    24: {
      title: "Fefferman",
      description:
        "Pion Boost gives free Incrementy Boost levels and double Origin gain",
      cost: new Decimal(25),
      unlocked() {
        return (
          (hasUpgrade("o", 23) && getBuyableAmount("o", 13).gte(2)) ||
          player.c.best.gt(0)
        );
      }
    },
    25: {
      ...
      unlocked() {
        return (
          (hasUpgrade("o", 24) && getBuyableAmount("o", 13).gte(3)) ||
          getBuyableAmount("o", 12).gte(3) ||
          player.c.best.gt(0)
        );
      }
    },
    31: {
      title: "Quillen",
      description:
        "Unlock three Origin buyables and each Incrementy Boost buyable adds .001 to its base",
      cost: new Decimal(200),
      unlocked() {
        return (
          (hasUpgrade("o", 25) &&
            getBuyableAmount("o", 13).gte(3) &&
            getBuyableAmount("o", 12).gte(3)) ||
          player.c.best.gt(0)
        );
      }
    ...
    32: {
      title: "Connes",
      description:
        "Stamina Boost buyables give levels to Incrementy Boost and each Pion Boost buyable adds .002 to its base",
      cost: new Decimal(200),
      unlocked() {
    ...
    33: {
      title: "Yau",
      description:
        "Each Incrementy Boost buyable increases the Incrementy Stamina softcap start by one",
    ...
    34: {
      title: "Donaldson",
      description:
        "Each Origin upgrade gives a free Incrementy Boost buyable and triple Origin gain",
      cost: new Decimal(500),
      unlocked() {
        return (
          (hasUpgrade("o", 33) && getBuyableAmount("o", 22).gte(1)) ||
          player.c.best.gt(0)
        );
      }
    },
    35: {
      title: "Faltings",
      description:
        "Remove the ability to Prestige but gain 100% of Origins on prestige per second",
      cost: new Decimal(2500),
      unlocked() {
        return (
          (hasUpgrade("o", 34) && getBuyableAmount("o", 21).gte(2)) ||
          player.c.best.gt(0)
        );
      }
    },
    41: {
      title: "Freedman",
      description:
        "Origin Boost gives free levels to Super Prestige Boost and gain two free Origin Boosts",
    ...
    42: {
      title: "Drinfeld",
      description:
        "Super Prestige Boost gives free levels to Particle Boost and push the Incrementy Stamina softcap start back by 42",
    ...
    43: {
      title: "Mori",
      description:
        "Unlock a third row of Origin Buyables and each Incrementy Boost buyable adds .01 to Origin Boost base",
    ...
    44: {
      title: "Jones",
      description:
        "Neutrino Boost levels give three free levels to Super Prestige Boost and one to Origin Boost",
    ...
    45: {
      title: "Bourgain",
      description:
        "Shard Boost gives free levels to Neutrino Boost and add .1 to the Incrementy Boost base",
    ...
    51: {
      title: "Witten",
      description:
        "Origin Boost gives free levels to Particle Boost and add .1 to the base",
    ...
    52: {
      title: "Lions",
      description:
        "Gain two free levels of Shard Boost and Neutrino Autobuyers can buy 100x more",
      cost: new Decimal(1e24),
      unlocked() {
    ...
    54: {
      title: "Zelmanov",
      description:
        "Per Origin Boost Buyables cubed you can buy one more Incrementy Stamina level and unlock Fragments",
  ...
  milestones: {
    0: {
      ...
      effectDescription:
        "Origin effect boosts Base Incrementy, autobuyers buy 10x more, and each Origin milestone raises Boson Challenge goals ^.98",
      done() {
    ...
    1: {
      ...
      effectDescription:
        "Origin effect boosts Antimatter and you always have autobuyers",
      done() {
    ...
    2: {
      ...
      effectDescription:
        "Origin effect boosts Amoebas and total Origins multiply Shard gain",
      done() {
    ...
    3: {
      ...
      effectDescription() {
        let a =
          "Origin effect boosts Matter and best Origins logarithmically boost Super Prestige Point gain, currently: ";
    ...
    4: {
      ...
      effectDescription:
        "Origin effect boosts Particles and keep Boson Challenge completions",
      done() {
    ...
    5: {
      ...
      effectDescription:
        "Origin effects Shards, keep the first four rows of Super Prestige upgrades, and Super Prestige times",
      done() {
    ...
    6: {
      ...
      effectDescription:
        "Origin effects Super Prestige Points and keep the fifth row of Super Prestige upgrades",
      done() {
    ...
    Upgrades: {
      content: [
        ...
        [
          ...
          "",
          function() {
            return hasUpgrade("o", 35) ? { display: "none" } : {};
          }
        ],
        [
          "prestige-button",
        ...
        [
          ...
          function() {
            if (!hasUpgrade("o", 35))
              return "You have " + format(player.pi.points) + " Pions";
            return (
              "You are gaining " +
              format(layers.o.getResetGain()) +
              " Origins per second"
            );
          }
        ],
...
addLayer("f", {
  ...
  effect() {
    ...
    if (hasUpgrade("f", 22))
      ret = ret.pow(Decimal.pow(player.f.upgrades.length, 2).max(1));
  ...
  getGainMultPost() {
    ...
    x = x.times(
      Decimal.pow(layers.f.co2Effect(), layers.o.buyables[33].total())
    );
  ...
  canReset() {
    return (
      layers.f.getResetGain().gt(0) &&
      hasUpgrade("pi", 44) &&
      player.f.currentTime >= 5 &&
      (player.f.currentTime >= 30 || hasMilestone("c", 2))
    );
  },
  update(diff) {
    ...
    if (hasUpgrade("f", 41)) {
      let t = layers.f.clickables
        .getMaximumPossible(31)
        .times(diff)
        .times(0.01)
        .max(0);
    ...
    if (hasUpgrade("f", 24)) generatePoints("f", Decimal.times(diff, 0.01));
    if (hasUpgrade("f", 25)) generatePoints("f", Decimal.times(diff, 0.99));
  ...
  upgrades: {
    ...
    13: {
      title: "Kontsevich",
      description:
        "Per Fragment upgrade per Base Origin Boost add .01 to the Pion Boost base",
    ...
    15: {
      ...
      cost: new Decimal(1e4),
      effect() {
        return Decimal.pow(2, player.f.upgrades.length).pow(
          layers.f.rubpEffect()
        );
      },
      unlocked() {
    ...
    22: {
      title: "Okounkov",
      description:
        "Raise fragement effect to the square of the Fragment upgrade amount and first row Workers do not cost Fragments",
    ...
    23: {
      title: "Perelman",
      description:
        "Phosphorus Gatherers give free levels to Super Prestige Boost",
    ...
    24: {
      title: "Tao",
      description:
        "Second row Workers do not cost Fragments and gain 1% of Fragments upon prestige each second",
    ...
    25: {
      title: "Werner",
      description:
        "Remove the ability to Prestige but gain 99% of Fragments upon prestige each second",
    ...
    33: {
      title: "Smirnov",
      description:
        "Buy one Origin buyable per second and square Carbon Dioxide and NADPH base",
      cost: new Decimal(1e29),
      unlocked() {
    ...
    34: {
      ...
      unlocked() {
        return (
          (hasUpgrade("f", 33) && player.i.points.gt(new Decimal("4pt10"))) ||
          hasUpgrade("f", 34) ||
          player.c.best.gt(0)
        );
      }
    ...
    41: {
      title: "Hairer",
      description:
        "Gain 1% of your F6P upon click per second but disable Avila",
  ...
  buyables: {
    ...
    allMult() {
      ...
      if (hasUpgrade("f", 32))
        ret = ret.times(Decimal.pow(player.f.upgrades.length, 2).max(1));
    ...
    11: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.f.buyables[11]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: " +
          format(layers.f.buyables[11].effect(), 4) +
          "/s</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.f.buyables[11].cost()) +
          " Fragments</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.f.buyables[11].perProduction(), 3) +
          "/s per worker</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
    ...
    12: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.f.buyables[12]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: " +
          format(layers.f.buyables[12].effect(), 4) +
          "/s</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.f.buyables[12].cost()) +
          " Fragments</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.f.buyables[12].perProduction(), 3) +
          "/s per worker</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
    ...
    13: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.f.buyables[13]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: " +
          format(layers.f.buyables[13].effect(), 4) +
          "/s</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.f.buyables[13].cost()) +
          " Fragments</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.f.buyables[13].perProduction(), 3) +
          "/s per worker</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
    ...
    21: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.f.buyables[21]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: " +
          format(layers.f.buyables[21].effect(), 4) +
          "/s</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.f.buyables[21].cost()) +
          " Fragments</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.f.buyables[21].perProduction(), 3) +
          "/s per worker</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
    ...
    22: {
      title:
        "<h3 style='font-size:100%;color: #A000A0'>Phosphorus</h3> <h3 style='font-size:100%'>Gatherer</h3>",
      display() {
        let additional = "";
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.f.buyables[22]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: " +
          format(layers.f.buyables[22].effect(), 4) +
          "/s</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.f.buyables[22].cost()) +
          " Fragments</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.f.buyables[22].perProduction(), 3) +
          "/s per worker</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
    ...
    23: {
      ...
      display() {
        ...
        let start =
          "<b><h2>Amount</h2>: " +
          formatWhole(player.f.buyables[23]) +
          additional +
          "</b><br>";
        let eff =
          "<b><h2>Effect</h2>: " +
          format(layers.f.buyables[23].effect(), 4) +
          "/s</b><br>";
        let cost =
          "<b><h2>Cost</h2>: " +
          format(layers.f.buyables[23].cost()) +
          " Fragments</b><br>";
        let eformula =
          "<b><h2>Effect formula</h2>:<br>" +
          format(layers.f.buyables[23].perProduction(), 3) +
          "/s per worker</b><br>";
        let end = shiftDown ? eformula : "Shift to see details";
        return "<br>" + start + eff + cost + end;
      },
  ...
  clickables: {
    ...
    getMaximumPossible(id, mode = "buy") {
      ...
      if (id == 12) {
        target = player.f.h
          .div(12)
          .min(player.f.o.div(6))
          .min(player.f.c.div(6));
        if (mode == "buy")
          return target
            .minus(1)
            .div(10)
      ...
      if (id == 14) {
        target = player.f.h
          .div(16)
          .min(player.f.n.div(5))
          .min(player.f.p.div(3))
          .min(player.f.c.div(10))
          .min(player.f.o.div(13));
        if (mode == "buy")
          return target
            .minus(1)
            .div(10)
      ...
      if (id == 21) {
        target = player.f.h
          .div(29)
          .min(player.f.n.div(7))
          .min(player.f.p.div(3))
          .min(player.f.c.div(21))
          .min(player.f.o.div(17));
        if (mode == "buy")
          return target
            .minus(1)
            .div(10)
      ...
      if (id == 23) {
        target = player.f.h
          .div(12)
          .min(player.f.p.div(2))
          .min(player.f.c.div(5))
          .min(player.f.o.div(11));
        if (mode == "buy")
          return target
            .minus(1)
            .div(10)
      ...
      if (id == 24) {
        target = player.f.h
          .div(13)
          .min(player.f.p.div(1))
          .min(player.f.c.div(6))
          .min(player.f.o.div(9));
        if (mode == "buy")
          return target
            .minus(1)
            .div(10)
      ...
      if (id == 25) {
        target = player.f.h
          .div(38)
          .min(player.f.p.div(3))
          .min(player.f.c.div(23))
          .min(player.f.o.div(17))
          .min(player.f.n.div(7))
          .min(player.f.s.div(1));
        if (mode == "buy")
          return target
            .minus(1)
            .div(10)
    ...
    11: {
      title:
        "<h3 style='color: #303000'>Water</h3><br><h3 style='color: #A00000'>H</h3><sub>2</sub><h3 style='color: #00A000'>O</h3>",
      display() {
        let target = layers.f.clickables.getMaximumPossible(11);

        let a =
          "Purchase 10% of the max possible<br>(" + formatWhole(target) + ")";
        let b =
          "You have " + formatWhole(player.f.molecules.water) + "<br>Water";
        return a + "<br><br>" + b;
      },
      unlocked() {
        return true;
    ...
    12: {
      title:
        "<h3 style='color: #703000'>Glucose</h3><br><h3 style='color: #00A0A0'>C</h3><sub>6</sub><h3 style='color: #A00000'>H</h3><sub>12</sub><h3 style='color: #00A000'>O</h3><sub>6</sub>",
      display() {
        ...
        let a =
          "Purchase 10% of the max possible<br>(" + formatWhole(target) + ")";
        let b =
          "You have " + formatWhole(player.f.molecules.glucose) + "<br>Glucose";
        return a + "<br><br>" + b;
      },
      unlocked() {
        return true;
    ...
    13: {
      title:
        "<h3 style='color: #703070'>Ammonia</h3><br><h3 style='color: #0000A0'>N</h3><h3 style='color: #A00000'>H</h3><sub>3</sub>",
      display() {
        ...
        let a =
          "Purchase 10% of the max possible<br>(" + formatWhole(target) + ")";
        let b =
          "You have " + formatWhole(player.f.molecules.ammonia) + "<br>Ammonia";
        return a + "<br><br>" + b;
      },
      unlocked() {
    ...
    14: {
      title:
        "<h3 style='color: #6F0066'>ATP</h3><br><h3 style='color: #00A0A0'>C</h3><sub>10</sub><h3 style='color: #A00000'>H</h3><sub>16</sub><h3 style='color: #0000A0'>N</h3><sub>5</sub><h3 style='color: #00A000'>O</h3><sub>13</sub><h3 style='color: #A000A0'>P</h3><sub>3</sub>",
      display() {
    ...
    15: {
      title:
        "<h3 style='color: #6F0000'>Methane</h3><br><h3 style='color: #00A0A0'>C</h3><h3 style='color: #A00000'>H</h3><sub>4</sub>",
      display() {
        ...
        let a =
          "Purchase 10% of the max possible<br>(" + formatWhole(target) + ")";
        let b =
          "You have " + formatWhole(player.f.molecules.methane) + "<br>Methane";
        return a + "<br><br>" + b;
      },
      unlocked() {
        return hasUpgrade("f", 22) || player.c.best.gt(0);
    ...
    21: {
      title:
        "<h3 style='color: #746F1C'>NADPH</h3><br><h3 style='color: #00A0A0'>C</h3><sub>21</sub><h3 style='color: #A00000'>H</h3><sub>29</sub><h3 style='color: #0000A0'>N</h3><sub>7</sub><h3 style='color: #00A000'>O</h3><sub>17</sub><h3 style='color: #A000A0'>P</h3><sub>3</sub>",
      display() {
        ...
        let a =
          "Purchase 10% of the max possible<br>(" + formatWhole(target) + ")";
        let b =
          "You have " + formatWhole(player.f.molecules.nadph) + "<br>NADPH";
        return a + "<br><br>" + b;
      },
      unlocked() {
    ...
    22: {
      title() {
        ...
        return (
          "<h3 style='color: #336000;font-size:100%'>" +
          inner +
          "</h3><br><h3 style='color: #00A0A0'>C</h3><h3 style='color: #00A000'>O</h3><sub>2</sub>"
        );
      },
      display() {
        ...
        let b =
          "You have " +
          formatWhole(player.f.molecules.co2) +
          "<br>Carbon Dioxide";
        return a + "<br><br>" + b;
      },
      unlocked() {
    ...
    24: {
      ...
      display() {
        ...
        let a =
          "Purchase 10% of the max possible (" + formatWhole(target) + ")";
    ...
    25: {
      ...
      display() {
        ...
        let b =
          "You have " +
          formatWhole(player.f.molecules.acetylcoa) +
          "<br>Acetyl CoA";
        return a + "<br><br>" + b;
      },
      unlocked() {
      ...
      onClick() {
        ...
        player.f.molecules.acetylcoa = player.f.molecules.acetylcoa.plus(
          target
        );
        if (target.gt(new Decimal("10pt3"))) return;
    ...
    Upgrades: {
      content: [
        ...
        [
          ...
          "",
          function() {
            return hasUpgrade("f", 25) ? { display: "none" } : {};
          }
        ],
        [
          "prestige-button",
        ...
        [
          ...
          function() {
            if (!hasUpgrade("f", 25)) {
              if (hasMilestone("c", 2))
                return (
                  "There is a five second cooldown for Prestiging (" +
                  format(Math.max(0, 5 - player.f.currentTime)) +
                  ")"
                );
              return (
                "There is a thirty second cooldown for Prestiging (" +
                format(Math.max(0, 30 - player.f.currentTime)) +
                ")"
              );
            }
            return (
              "You are gaining " +
              format(layers.f.getResetGain()) +
      ...
      content: [
        [
          ...
          function() {
            ...
            let a =
              `You have <h2 style='color: #41FFEC'>` +
              format(player.f.h, 4) +
              "</h2> <h3 style='color: #A00000'>Hydrogen</h3><br>";
            let b =
              `You have <h2 style='color: #41FFEC'>` +
              format(player.f.o, 4) +
              "</h2> <h3 style='color: #00A000'>Oxygen</h3><br>";
            let c =
              `You have <h2 style='color: #41FFEC'>` +
              format(player.f.c, 4) +
              "</h2> <h3 style='color: #00A0A0'>Carbon</h3><br>";
            let d =
              `You have <h2 style='color: #41FFEC'>` +
              format(player.f.n, 4) +
              "</h2> <h3 style='color: #0000A0'>Nitrogen</h3><br>";
            let e =
              `You have <h2 style='color: #41FFEC'>` +
              format(player.f.p, 4) +
              "</h2> <h3 style='color: #A000A0'>Phosphorus</h3><br>";
            let f =
              `You have <h2 style='color: #41FFEC'>` +
              format(player.f.s, 4) +
              "</h2> <h3 style='color: #F0A000'>Sulfur</h3><br>";
            return a + b + c + d + e + f;
          }
        ],
        "clickables"
      ...
      content: [
        ...
        [
          ...
          function() {
            ...
            let a =
              `You have <h2 style='color: #41FFEC'>` +
              formatWhole(player.f.molecules.water, 4) +
              "</h2> <h3 style='color: #303000'>" +
              names[0] +
              "</h3> which gives +" +
              format(layers.f.waterEffect()) +
              " to Base Origin Boost Base<br>";
            let b =
              `You have <h2 style='color: #41FFEC'>` +
              formatWhole(player.f.molecules.glucose, 4) +
              "</h2> <h3 style='color: #703000'>" +
              names[1] +
              "</h3> which gives *" +
              format(layers.f.glucoseEffect()) +
              " Fragment gain<br>";
            let c =
              `You have <h2 style='color: #41FFEC'>` +
              formatWhole(player.f.molecules.ammonia, 4) +
              "</h2> <h3 style='color: #703070'>" +
              names[2] +
              "</h3> which pushes the Stamina softcap back by " +
              formatWhole(layers.f.ammoniaEffect()) +
              "<br>";
            let d =
              `You have <h2 style='color: #41FFEC'>` +
              formatWhole(player.f.molecules.atp, 4) +
              "</h2> <h3 style='color: #6F0066'>" +
              names[3] +
              "</h3> which multiplies worker effeciency by " +
              format(layers.f.atpEffect()) +
              "<br>";
            let e =
              `You have <h2 style='color: #41FFEC'>` +
              formatWhole(player.f.molecules.methane, 4) +
              "</h2> <h3 style='color: #6F0000'>" +
              names[4] +
              "</h3> which multiplies Origin gain by " +
              format(layers.f.methaneEffect()) +
              "<br>";

            let f =
              `You have <h2 style='color: #41FFEC'>` +
              formatWhole(player.f.molecules.nadph, 4) +
              "</h2> <h3 style='color: #746F1C'>" +
              names[5] +
              "</h3> which adds by +" +
              format(layers.f.nadphEffect()) +
              " to the Pion Boost base<br>";
            let g =
              `You have <h2 style='color: #41FFEC'>` +
              formatWhole(player.f.molecules.co2, 4) +
              "</h2> <h3 style='color: #336000'>" +
              names[6] +
              "</h3> which makes each Base Origin Boost multiply Fragment gain by " +
              format(layers.f.co2Effect(), 4) +
              " (total " +
              format(
                Decimal.pow(layers.f.co2Effect(), layers.o.buyables[33].total())
              ) +
            ...
            let h =
              `You have <h2 style='color: #41FFEC'>` +
              formatWhole(player.f.molecules.rubp, 4) +
              "</h2> <h3 style='color: #CC33FF'>" +
              names[7] +
              "</h3> which raises the " +
              names[3] +
              " and Lafforgue effects ^" +
              format(layers.f.rubpEffect(), 4) +
              "<br>";
            let i =
              `You have <h2 style='color: #41FFEC'>` +
              formatWhole(player.f.molecules.g6p, 4) +
              "</h2> <h3 style='color: #46582E'>" +
              names[8] +
              "</h3> which gives " +
              formatWhole(layers.f.g6pEffect()) +
              " free Base Origin Boost base<br>";
            let j =
              `You have <h2 style='color: #41FFEC'>` +
              formatWhole(player.f.molecules.acetylcoa, 4) +
              "</h2> <h3 style='color: #3300CC'>" +
              names[9] +
              "</h3> which powers Methane effect and Super Prestige Boost base ^" +
              format(layers.f.acetylcoaEffect(), 4) +
              "<br>";

            let k =
              `You have <h2 style='color: #41FFEC'>` +
              formatWhole(player.f.molecules.f6p, 4) +
              "</h2> <h3 style='color: #00582E'>" +
              names[10] +
              "</h3> which buffs all previous effects to " +
              format(layers.f.f6pEffect(), 4) +
              " times the strength<br>";

            if (!layers.f.clickables.rowunlocked(2)) return a + b + c + d + e;
            if (!layers.f.clickables.rowunlocked(3))
              return a + b + c + d + e + f + g + h + i + j;
            if (!layers.f.clickables.rowunlocked(4))
...
addLayer("c", {
  ...
  effectDescription() {
    ...
    let a =
      "which increases Super Prestige effect and gain by " +
      format(eff) +
      " (based on best Capsules)";
  ...
  getGainMultPost() {
    ...
    if (hasUpgrade("c", 22))
      x = x.times(Decimal.pow(2, player.c.upgrades.length));
    return x;
  },
  prestigeButtonText() {
  ...
  canReset() {
    return (
      layers.c.getResetGain().gt(0) &&
      hasUpgrade("f", 42) &&
      layers.c.baseAmount().gte(layers.c.requires)
    );
  },
  update(diff) {
  ...
  upgrades: {
    ...
    12: {
      title: "Zermelo",
      description:
        "Keep the last row of Super Prestige upgrades and raise Capsule gain to the number of Capsule upgrades",
      cost: new Decimal(10),
      unlocked() {
    ...
    14: {
      title: "Skolem",
      description:
        "Remove the ability to Prestige but gain 100% of Capsules upon prestige each second",
    ...
    31: {
      title: "Endgame?",
      description:
        "Unlock the ability to end the game and multiply base Capsule gain by 2.18",
  ...
  milestones: {
    1: {
      ...
      effectDescription:
        "Each Capsule reset raises all previous layer production and token gain exponents ^1.01 and gain 3x more SP resets per reset",
      done() {
    ...
    2: {
      ...
      effectDescription:
        "Make the fragment cooldown 5 seconds, gain 5x more SP resets per reset, and Capsule effect effects tokens",
      done() {
    ...
    3: {
      ...
      effectDescription:
        "Start with one SP reset per Capsule reset and Capsule effect effects Fragments and gatherers",
      done() {
    ...
    4: {
      ...
      effectDescription:
        "Keep SP milestones and Smirnov and raise capsule gain to the number of Milestones",
      done() {
    ...
    5: {
      ...
      effectDescription:
        "Keep the first four rows of Super Prestige upgrades and the first two rows of Pion upgrades",
      done() {
    ...
    6: {
      ...
      effectDescription:
        "Keep one Origin upgrade per Capsule reset and Avilia buys the first ten molecules too",
      done() {
    ...
    Upgrades: {
      content: [
        ...
        [
          ...
          "",
          function() {
            return hasUpgrade("c", 14) ? { display: "none" } : {};
          }
        ],
        [
          "prestige-button",
        ...
        [
          ...
          function() {
            if (!hasUpgrade("c", 14)) {
              if (player.c.times < 25)
                return (
                  "You have done " +
                  formatWhole(player.c.times) +
                  " Capsule resets"
                );
              return "";
            }
